...
export const ROLE_PERMISSIONS: Record<Role, string[]> = {
  super_admin: ['orders', 'products', 'customers', 'addons', 'settings', 'analytics', 'staffs', 'coupons', 'categories'],
  manager: ['orders', 'products', 'customers', 'analytics', 'coupons', 'categories'],

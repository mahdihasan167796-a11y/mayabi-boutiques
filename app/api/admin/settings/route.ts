...
export async function PATCH(request: Request) {
  ...
  const { data, error } = await supabaseAdmin
    ...
    .upsert({
      ...
      free_shipping_threshold: body.freeShippingThreshold ? Number(body.freeShippingThreshold) : 0,
      hero_video_url: body.heroVideoUrl ?? "",
      sslcommerz_enabled: body.sslcommerzEnabled ?? false,
      ...
      exclusive_title: body.exclusiveTitle ?? "",
      exclusive_subtitle: body.exclusiveSubtitle ?? "",
      exclusive_button_text: body.exclusiveButtonText ?? "",
      exclusive_button_link: body.exclusiveButtonLink ?? "",
      exclusive_image_1: body.exclusiveImage1 ?? "",
      exclusive_image_2: body.exclusiveImage2 ?? "",
      exclusive_image_3: body.exclusiveImage3 ?? "",

...
const playNotificationSound = () => {
  ...
  <div className="max-w-[1400px] mx-auto px-4 sm:px-6 pt-0 pb-12 bg-[#0a0a0a] min-h-screen text-zinc-100">
      {/* 🟢 প্রফেশনাল হেডার */}
      <div className="sticky top-0 z-40 bg-[#121211] border border-[#c9a054]/40 rounded-b-2xl p-4 sm:p-5 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-2xl">
